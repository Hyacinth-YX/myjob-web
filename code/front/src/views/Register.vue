<template>
  <div>
    ...
    <div class="shadow-3 register-card bg-white" style="border-radius: 25px">
      ...
      <q-form @submit="onSubmit" class="q-gutter-md q-ml-xl q-mr-xl">
        <q-input
          filled
          v-model="username"
          label="Username"
        ...
        <q-toggle v-model="accept"
          >I accept the license and <a href="#">terms</a></q-toggle
        >
...
export default {
  ...
  methods: {
    ...
    onSubmit: async function () {
      ...
      let res = await this.$api.user.register(data);
      if (res.data.code !== 0) {
        this.$q.notify({
